...
/**
 * Clase que representa un modelo de envío.
 *
 * @author israel
 * @version $Id: $Id
 */
public class ModeloEnvio {
     ...
     */
    private static final Logger logger = LoggerFactory.getLogger(ModeloEnvio.class);
     ...
     */
    public ModeloEnvio(String cod_tracking, int cod_carga_entrega, String cod_conductor, String cod_vehiculo) {
