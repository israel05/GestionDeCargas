 ...
 * @version $Id: $Id
 */
public class ImageTableCellParaDocumentosCapacitacion extends TableCell<ModeloDocumentoCapacitacion, Blob> {
    /**
     * Logger para esta clase
     */
    private static final Logger logger = LoggerFactory.getLogger(ImageTableCellParaDocumentosCapacitacion.class);

    private final ImageView imageView = new ImageView();

    /**
     * <p>Constructor for ImageTableCellParaDocumentosCapacitacion.</p>
     */
    public ImageTableCellParaDocumentosCapacitacion() {
