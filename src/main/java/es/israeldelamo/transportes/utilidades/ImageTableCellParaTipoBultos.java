 ...
 * @version $Id: $Id
 */
public class ImageTableCellParaTipoBultos extends TableCell<ModeloTipoDeBulto, Blob> {
    /**
     * Logger para esta clase
     */
    private static final Logger logger = LoggerFactory.getLogger(ImageTableCellParaTipoBultos.class);

    private final ImageView imageView = new ImageView();

    /**
     * Utilidad para poder poner una imagen en tipo de bultos tabla
     */
    public ImageTableCellParaTipoBultos() {
