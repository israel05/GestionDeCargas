 ...
 * @version $Id: $Id
 */
public class ImageTableCellParaConductores extends TableCell<ModeloConductor, Blob> {
    /**
     * Logger para esta clase
     */
    private static final Logger logger = LoggerFactory.getLogger(ImageTableCellParaConductores.class);

    /**
     * ImageView to display the image within the table cell.
     */
    private final ImageView imageView = new ImageView();

    /**
     * <p>Constructor for ImageTableCellParaConductores.</p>
     */
    public ImageTableCellParaConductores() {
